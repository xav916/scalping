...
Généré : 2026-07-31 19:24 Paris · auto-routine hebdo
...
|---|---|---|---|---|---|
| 2026-07-28 03:42:40 | `EUR/USD` | buy | **PAUSED** | auto | auto-pause: pnl_pct -109.99% < -3% |
| 2026-07-28 01:42:40 | `XAU/USD` | buy | **DEMOTED** | auto | auto-demote: 3 pauses on 60d (max 2) |
| 2026-07-28 01:42:40 | `EUR/USD` | buy | **AUTO_EXEC** | auto | cool-off 14j expired, re-evaluating live |
...
| `WTI/USD` | **AUTO_EXEC** | 30 / +41.48% | **AUTO_EXEC** | 30 / +1.73% |
| `XAG/USD` | **DEMOTED** | 30 / -97.74% | **DEMOTED** | 30 / -10.78% |
| `XAU/USD` | **DEMOTED** | 30 / -113.16% | **AUTO_EXEC** | 30 / +10.58% |
