# 2026-08-29 — Track A × veto contrefactuel (auto)

**Sample :** 955 réconciliés (INSUFFISANT — observer mais ne pas trancher)
**Verdict :** insufficient

# Track A × Veto géopolitique — analyse contrefactuelle

**Généré :** 2026-08-29T06:01:41+00:00
**Source :** `shadow_setups` filtre `outcome IS NOT NULL AND geopolitical_features_json IS NOT NULL`
**Échantillon :** 955 setups réconciliés
...
|---|---:|---:|---:|---:|---:|---:|---:|---:|
| Tous | 955 | 271 | 389 | 295 | 41.1% | 2.55 | +1.51% | +1444.04% |
| Would VETO | 29 | 5 | 9 | 15 | 35.7% | 1.58 | +0.60% | +17.30% |
| Would PASS | 926 | 266 | 380 | 280 | 41.2% | 2.58 | +1.54% | +1426.74% |

## Verdict directionnel

**ÉCHANTILLON INSUFFISANT POUR TRANCHER** : seuls **29** setups auraient été bloqués par le veto (seuil : 30). Les 926 autres ne servent que de témoin — c'est le plus petit groupe qui borne la conclusion.
...
Ces paires gagnent (ou perdent) **100 % du temps**, alors que l'ensemble gagne 50.1 %. Presque sûrement un artefact de log, pas un résultat.
