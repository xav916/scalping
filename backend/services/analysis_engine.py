...
def enrich_trade_setup(
    ...
    # ── Kraken Futures funding rate scoring (2026-08-02) ─────────────────
    ...
    # Note : le routing destination_id n'est pas disponible ici (résolu après
    # l'enrichissement dans bridge_destinations.py).
    try:
    ...
    # ── Kraken Futures OI divergence scoring (2026-08-02) ────────────────
    ...
    # ── Kraken Futures order book depth scoring (2026-08-02) ─────────────
