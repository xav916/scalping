...
export const TIPS = {
  ...
  trade: {
    ...
    notional: 'Exposition (notional) : prix × units × size. Montant auquel on est exposé au marché. Si le prix bouge de 1%, on gagne ou perd 1% × notional.',
    margin: 'Bloqué : capital que Pepperstone immobilise sur le compte le temps de la position (margin requise). Estimé via le leverage par asset_class (forex 30x, metal/index 20x, energy 10x, crypto 2x). Différent du risque (perte si SL hit) et de l\'exposition (notional).',
